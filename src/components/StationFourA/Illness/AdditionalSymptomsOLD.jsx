    ...
    <>
      ...
      {isShown && (
        <div className="col-lg-12">
            ...
            <div className="">
              ...
              <div className="form-check form-check-inline">
                <input
                  ...
                  value=""
                />
                <label className="form-check-label text-capitalize" for="yes1">
                  yes
                </label>
              </div>
            </div>
            ...
            <div className="">
              ...
              <div className="form-check form-check-inline">
                <input
                  ...
                  value=""
                />
                <label className="form-check-label text-capitalize" for="yes2">
                  yes
                </label>
              </div>
            </div>
            ...
            <div className="">
              ...
              <div className="form-check form-check-inline">
                <input
                  ...
                  value=""
                />
                <label className="form-check-label text-capitalize" for="yes3">
                  yes
                </label>
              </div>
            </div>
          ...
          <div className="d-flex justify-content-between">
            <div className="">
              <p className="font-16">Hemoptysis (Coughing up to blood)</p>
            </div>
            <div className="">
              <div className="form-check form-check-inline">
                <input
              ...
              <div className="form-check form-check-inline">
                <input
                  ...
                  value=""
                />
                <label className="form-check-label text-capitalize" for="yes4">
                  yes
                </label>
              </div>
            </div>
