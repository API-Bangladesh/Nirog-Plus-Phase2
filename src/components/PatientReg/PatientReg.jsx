...
const PatientReg = () => {
  ...
  const handleSelectInputChange = async (e) => {
    ...
    isPermanentSameAsPresent
      ? setErrors({ ...errors, [field]: null, [parmanentField]: null })
      : setErrors({ ...errors, [field]: null });
    ...
    setSelectedAddress((prev) => ({
      ...prev,
      [field]: e,
      ...(isPermanentSameAsPresent ? { [parmanentField]: e } : { [field]: e }),
    }));
  };
              ...
              <div className="col-lg-6">
                ...
                <div className="mb-3">
                  ...
                  <Select
                    ...
                    classNamePrefix="select"
                    options={
                      isPermanentSameAsPresent ? districts : districtsParmanent
                    }
                    onChange={(e) => {
                      handleSelectInputChange(e);
                ...
                <div className="mb-3">
                  ...
                  <Select
                    ...
                    classNamePrefix="select"
                    options={
                      isPermanentSameAsPresent ? upazilas : upazilasParmanent
                    }
                    onChange={(e) => {
                      handleSelectInputChange(e);
                ...
                <div className="mb-3">
                  ...
                  <Select
                    ...
                    classNamePrefix="select"
                    options={
                      isPermanentSameAsPresent ? unions : unionsParmanent
                    }
                    // onChange={handleSelectInputChange}
                    onChange={(e) => {
                      handleSelectInputChange(e);
