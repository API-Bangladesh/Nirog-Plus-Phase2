      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            exact
            path="/take-photo"
            element={<Protected Component={TakePhoto} />}
          />
          <Route
            exact
            path="/user-details"
          ...
          <Route
            exact
            path="/user-table"
            element={<Protected Component={UserTable} />}
          />
          <Route
            exact
            path="/height-weight"
            element={<Protected Component={StationHeight} />}
          />
          <Route
            exact
            path="/blood-pressure"
            element={<Protected Component={BloodPressure} />}
          />
          <Route
            exact
            path="/blood-pressure-table"
            element={<Protected Component={BloodPressureTable} />}
          />
          <Route
            exact
            path="/glucose-hemoglobin-table"
            element={<Protected Component={GlucoseHemTable} />}
          />
          <Route
            exact
          ...
          <Route
            exact
            path="/user-data"
            element={<Protected Component={TPuserData} />}
          />
          <Route
            exact
            path="/station-fourb"
          ...
          <Route
            exact
            path="/patient-list"
            element={<Protected Component={PatientDataList} />}
          />
          <Route
            exact
            path="/counter"
            element={<Protected Component={Counter} />}
          />
          <Route
            exact
            path="/settings"
          ...
          <Route
            exact
            path="/prescription"
            element={<Protected Component={Prescriptions} />}
          />
          <Route
            exact
            path="/final-prescription"
            element={<Protected Component={FinalPrescription} />}
          />
          <Route
            exact
            path="/Create"
            element={<Protected Component={CreatePage} />}
          />
